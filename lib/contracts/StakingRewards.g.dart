...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> rewards(_i1.EthereumAddress , {_i1.BlockNum? atBlock}) async  { final function = self.function('rewards');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> userRewardPerTokenPaid(_i1.EthereumAddress , {_i1.BlockNum? atBlock}) async  { final function = self.function('userRewardPerTokenPaid');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
