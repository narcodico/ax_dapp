...
Dialog dualDepositDialog(
    BuildContext context, NFLAthlete athlete, double layoutWdt, bool isWeb) {
  TextEditingController stakeAxInput = TextEditingController();
  WalletController walletController = Get.find();
  double _height = MediaQuery.of(context).size.height;
  double wid = 390;
...
// dynamic
Dialog buyDialog(BuildContext context, NFLAthlete athlete) {
  bool isWeb = true;
  isWeb =
...
// dynamic
Dialog sellDialog(BuildContext context, NFLAthlete athlete) {
  bool isWeb = true;
  isWeb =
      kIsWeb && (MediaQuery.of(context).orientation == Orientation.landscape);
  double _height = MediaQuery.of(context).size.height;
...
// dynamic
Dialog mintDialog(BuildContext context, NFLAthlete athlete) {
  bool isWeb = true;
  isWeb =
      kIsWeb && (MediaQuery.of(context).orientation == Orientation.landscape);
  double _height = MediaQuery.of(context).size.height;
